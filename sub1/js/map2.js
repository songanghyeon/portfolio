 window.onload = function() {
    ...
    var options = {
        center: new daum.maps.LatLng(37.404418548733126, 127.09892075280766),
        level: 2
    };
    ...
    var markerPosition  = new daum.maps.LatLng(37.404418548733126, 127.09892075280766); 
    ...
    //두번째 맵
      ...
      var container2 = document.getElementById('map1');
    var options2 = {
        center: new daum.maps.LatLng(34.89787195892072, 128.60458969525894),
        level: 2
    };
    ...
    var markerPosition2  = new daum.maps.LatLng(34.89787195892072, 128.60458969525894); 
   ...
   var options3 = {
       center: new daum.maps.LatLng(36.392063788811235, 127.40226323392385),
       level: 2
   };
   ...
   var markerPosition3  = new daum.maps.LatLng(36.392063788811235, 127.40226323392385); 
   ...
   var overlay3 = new daum.maps.CustomOverlay({
    ...
    //네번째 맵
     ...
     var container4 = document.getElementById('map3');
   var options4 = {
       center: new daum.maps.LatLng(35.14821375200545, 129.06551700067604),
       level: 2
   };
   ...
   var markerPosition4  = new daum.maps.LatLng(35.14821375200545, 129.06551700067604); 
